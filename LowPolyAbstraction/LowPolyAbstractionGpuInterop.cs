...
internal sealed class LowPolyAbstractionGpuInterop : IDisposable
{
    ...
    private LowPolyAbstractionGpuInterop(
    ...
    public static unsafe LowPolyAbstractionGpuInterop? TryCreate(IGraphicsDevicesAndContext devices)
    {
        ...
        try
        {
            ...
            return new LowPolyAbstractionGpuInterop(device, d3dDevice, d3dContext, fence, renderContext, d3d12Fence);
        }
        catch
        {
